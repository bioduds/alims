...
function AppContent() {
  ...
  // Handle visualization updates with TLA+ validation
  const handleVisualizationUpdate = (viz: VisualizationData | null) => {
    ...
    <div className="h-screen bg-gray-900 text-white flex">
      ...
      <div className="w-96 bg-gray-800 border-r border-gray-700 flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          <MainInterfaceChat onVisualizationUpdate={handleVisualizationUpdate} />
        </div>
      </div>
      ...
      <div className="flex-1 bg-gray-900 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-700 bg-gray-800/50">
          <div className="flex space-x-2 text-xs">
            <button
              onClick={() => handleVisualizationUpdate({
                type: 'chart',
            ...
            <button
              onClick={() => handleVisualizationUpdate(null)}
...
// Wrap the app with TLA+ validation provider
function App() {
  return (
    <TLAStateProvider>
      <AppContent />
