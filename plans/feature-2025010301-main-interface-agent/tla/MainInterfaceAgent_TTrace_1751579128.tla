---- MODULE MainInterfaceAgent_TTrace_1751579128 ----
...
_inv ==
    ~(
        ...
        /\
        system_metrics = ([active_conversations |-> 1, response_time |-> 0])
        /\
        agent_registry = (<<"sample_tracker", "workflow_manager">>)
        /\
        conversation_contexts = (<<[messages |-> <<[content |-> "sample_inquiry", timestamp |-> 1, role |-> "user"]>>, current_context |-> {}, active_agents |-> {2}, user_intent |-> "WORKFLOW_COMMAND"]>>)
        /\
        central_brain_state = ("ORCHESTRATING")
        /\
        available_agents = ({<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>})
        /\
        user_requests = (<<>>)
        /\
        agent_responses = (<<[agent_id |-> 1, content |-> "sample_inquiry", timestamp |-> 1, success |-> FALSE]>>)
        /\
        conversations = ({<<1, "ACTIVE", 0>>})
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MainInterfaceAgent_TTrace_1751579128.json", _TETrace)
...
\*
\*trace == IODeserialize("MainInterfaceAgent_TTrace_1751579128.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([system_metrics |-> [active_conversations |-> 0, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<>>,central_brain_state |-> "READY",available_agents |-> {<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<>>,agent_responses |-> <<>>,conversations |-> {}]),
    ([system_metrics |-> [active_conversations |-> 1, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<[messages |-> <<>>, current_context |-> {}, active_agents |-> {}, user_intent |-> "UNKNOWN"]>>,central_brain_state |-> "READY",available_agents |-> {<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<>>,agent_responses |-> <<>>,conversations |-> {<<1, "ACTIVE", 0>>}]),
    ([system_metrics |-> [active_conversations |-> 1, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<[messages |-> <<[content |-> "sample_inquiry", timestamp |-> 1, role |-> "user"]>>, current_context |-> {}, active_agents |-> {}, user_intent |-> "UNKNOWN"]>>,central_brain_state |-> "READY",available_agents |-> {<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<[content |-> "sample_inquiry", priority |-> "LOW", conversation_id |-> 1, type |-> "WORKFLOW_COMMAND", timestamp |-> 1]>>,agent_responses |-> <<>>,conversations |-> {<<1, "ACTIVE", 0>>}]),
    ([system_metrics |-> [active_conversations |-> 1, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<[messages |-> <<[content |-> "sample_inquiry", timestamp |-> 1, role |-> "user"]>>, current_context |-> {}, active_agents |-> {2}, user_intent |-> "WORKFLOW_COMMAND"]>>,central_brain_state |-> "ORCHESTRATING",available_agents |-> {<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<>>,agent_responses |-> <<>>,conversations |-> {<<1, "ACTIVE", 0>>}]),
    ([system_metrics |-> [active_conversations |-> 1, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<[messages |-> <<[content |-> "sample_inquiry", timestamp |-> 1, role |-> "user"]>>, current_context |-> {}, active_agents |-> {2}, user_intent |-> "WORKFLOW_COMMAND"]>>,central_brain_state |-> "ORCHESTRATING",available_agents |-> {<<1, "BUSY", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<>>,agent_responses |-> <<>>,conversations |-> {<<1, "ACTIVE", 0>>}]),
    ([system_metrics |-> [active_conversations |-> 1, response_time |-> 0],agent_registry |-> <<"sample_tracker", "workflow_manager">>,conversation_contexts |-> <<[messages |-> <<[content |-> "sample_inquiry", timestamp |-> 1, role |-> "user"]>>, current_context |-> {}, active_agents |-> {2}, user_intent |-> "WORKFLOW_COMMAND"]>>,central_brain_state |-> "ORCHESTRATING",available_agents |-> {<<1, "IDLE", "sample_tracker">>, <<2, "IDLE", "workflow_manager">>},user_requests |-> <<>>,agent_responses |-> <<[agent_id |-> 1, content |-> "sample_inquiry", timestamp |-> 1, success |-> FALSE]>>,conversations |-> {<<1, "ACTIVE", 0>>}])
    >>
----
...
---- CONFIG MainInterfaceAgent_TTrace_1751579128 ----
CONSTANTS
    MAX_CONVERSATIONS = 2
    MAX_AGENTS = 2
    MAX_CONTEXT_DEPTH = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 03 18:47:28 BRT 2025