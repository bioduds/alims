---- MODULE MainInterfaceAgentIntegration_TTrace_1752698207 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MainInterfaceAgentIntegration_TTrace_1752698207.json", _TETrace)
...
\*
\*trace == IODeserialize("MainInterfaceAgentIntegration_TTrace_1752698207.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG MainInterfaceAgentIntegration_TTrace_1752698207 ----
CONSTANTS
    MAX_CONVERSATIONS = 5
    MAX_AGENTS = 5
    MAX_REQUESTS = 10
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jul 16 17:36:50 BRT 2025