---- MODULE MainInterfaceAgent_TTrace_1751578826 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MainInterfaceAgent_TTrace_1751578826.json", _TETrace)
...
\*
\*trace == IODeserialize("MainInterfaceAgent_TTrace_1751578826.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG MainInterfaceAgent_TTrace_1751578826 ----
CONSTANTS
    MAX_CONVERSATIONS = 3
    MAX_AGENTS = 4
    MAX_CONTEXT_DEPTH = 5
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 03 18:40:27 BRT 2025