---- MODULE TensorCalendarSystem_TTrace_1752121745 ----
...
_inv ==
    ~(
        ...
        /\
        systemMetrics = ([totalScheduled |-> 2, conflictCount |-> 0, utilizationRate |-> 40, averageLatency |-> -5])
        /\
        workflowTimelines = (<<{1}, {}>>)
        /\
        lastUpdate = (3)
        ...
        activeConstraints = ({})
        /\
        tensorCalendar = ([tensor |-> (<<1, 1, 1, 1>> :> TRUE @@ <<1, 1, 1, 2>> :> FALSE @@ <<1, 1, 2, 1>> :> FALSE @@ <<1, 1, 2, 2>> :> FALSE @@ <<1, 1, 3, 1>> :> FALSE @@ <<1, 1, 3, 2>> :> FALSE @@ <<1, 1, 4, 1>> :> FALSE @@ <<1, 1, 4, 2>> :> FALSE @@ <<1, 2, 1, 1>> :> TRUE @@ <<1, 2, 1, 2>> :> FALSE @@ <<1, 2, 2, 1>> :> FALSE @@ <<1, 2, 2, 2>> :> FALSE @@ <<1, 2, 3, 1>> :> FALSE @@ <<1, 2, 3, 2>> :> FALSE @@ <<1, 2, 4, 1>> :> FALSE @@ <<1, 2, 4, 2>> :> FALSE @@ <<2, 1, 1, 1>> :> FALSE @@ <<2, 1, 1, 2>> :> FALSE @@ <<2, 1, 2, 1>> :> FALSE @@ <<2, 1, 2, 2>> :> FALSE @@ <<2, 1, 3, 1>> :> FALSE @@ <<2, 1, 3, 2>> :> FALSE @@ <<2, 1, 4, 1>> :> FALSE @@ <<2, 1, 4, 2>> :> FALSE @@ <<2, 2, 1, 1>> :> FALSE @@ <<2, 2, 1, 2>> :> FALSE @@ <<2, 2, 2, 1>> :> FALSE @@ <<2, 2, 2, 2>> :> FALSE @@ <<2, 2, 3, 1>> :> FALSE @@ <<2, 2, 3, 2>> :> FALSE @@ <<2, 2, 4, 1>> :> FALSE @@ <<2, 2, 4, 2>> :> FALSE @@ <<3, 1, 1, 1>> :> FALSE @@ <<3, 1, 1, 2>> :> FALSE @@ <<3, 1, 2, 1>> :> FALSE @@ <<3, 1, 2, 2>> :> FALSE @@ <<3, 1, 3, 1>> :> FALSE @@ <<3, 1, 3, 2>> :> FALSE @@ <<3, 1, 4, 1>> :> FALSE @@ <<3, 1, 4, 2>> :> FALSE @@ <<3, 2, 1, 1>> :> FALSE @@ <<3, 2, 1, 2>> :> FALSE @@ <<3, 2, 2, 1>> :> FALSE @@ <<3, 2, 2, 2>> :> FALSE @@ <<3, 2, 3, 1>> :> FALSE @@ <<3, 2, 3, 2>> :> FALSE @@ <<3, 2, 4, 1>> :> FALSE @@ <<3, 2, 4, 2>> :> FALSE), conflicts |-> {}, capacity |-> <<1, 1>>, deadlines |-> <<4, 4, 4>>, dependencies |-> <<{}, {}>>])
        /\
        sampleSchedules = (<<{1}, {}, {}>>)
        /\
        resourceBookings = (<<{1}, {1}>>)
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TensorCalendarSystem_TTrace_1752121745.json", _TETrace)
...
\*
\*trace == IODeserialize("TensorCalendarSystem_TTrace_1752121745.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([systemMetrics |-> [totalScheduled |-> 2, conflictCount |-> 0, utilizationRate |-> 30, averageLatency |-> 0],workflowTimelines |-> <<{1}, {}>>,lastUpdate |-> 2,activeConstraints |-> {},tensorCalendar |-> [tensor |-> (<<1, 1, 1, 1>> :> TRUE @@ <<1, 1, 1, 2>> :> FALSE @@ <<1, 1, 2, 1>> :> FALSE @@ <<1, 1, 2, 2>> :> FALSE @@ <<1, 1, 3, 1>> :> FALSE @@ <<1, 1, 3, 2>> :> FALSE @@ <<1, 1, 4, 1>> :> FALSE @@ <<1, 1, 4, 2>> :> FALSE @@ <<1, 2, 1, 1>> :> TRUE @@ <<1, 2, 1, 2>> :> FALSE @@ <<1, 2, 2, 1>> :> FALSE @@ <<1, 2, 2, 2>> :> FALSE @@ <<1, 2, 3, 1>> :> FALSE @@ <<1, 2, 3, 2>> :> FALSE @@ <<1, 2, 4, 1>> :> FALSE @@ <<1, 2, 4, 2>> :> FALSE @@ <<2, 1, 1, 1>> :> FALSE @@ <<2, 1, 1, 2>> :> FALSE @@ <<2, 1, 2, 1>> :> FALSE @@ <<2, 1, 2, 2>> :> FALSE @@ <<2, 1, 3, 1>> :> FALSE @@ <<2, 1, 3, 2>> :> FALSE @@ <<2, 1, 4, 1>> :> FALSE @@ <<2, 1, 4, 2>> :> FALSE @@ <<2, 2, 1, 1>> :> FALSE @@ <<2, 2, 1, 2>> :> FALSE @@ <<2, 2, 2, 1>> :> FALSE @@ <<2, 2, 2, 2>> :> FALSE @@ <<2, 2, 3, 1>> :> FALSE @@ <<2, 2, 3, 2>> :> FALSE @@ <<2, 2, 4, 1>> :> FALSE @@ <<2, 2, 4, 2>> :> FALSE @@ <<3, 1, 1, 1>> :> FALSE @@ <<3, 1, 1, 2>> :> FALSE @@ <<3, 1, 2, 1>> :> FALSE @@ <<3, 1, 2, 2>> :> FALSE @@ <<3, 1, 3, 1>> :> FALSE @@ <<3, 1, 3, 2>> :> FALSE @@ <<3, 1, 4, 1>> :> FALSE @@ <<3, 1, 4, 2>> :> FALSE @@ <<3, 2, 1, 1>> :> FALSE @@ <<3, 2, 1, 2>> :> FALSE @@ <<3, 2, 2, 1>> :> FALSE @@ <<3, 2, 2, 2>> :> FALSE @@ <<3, 2, 3, 1>> :> FALSE @@ <<3, 2, 3, 2>> :> FALSE @@ <<3, 2, 4, 1>> :> FALSE @@ <<3, 2, 4, 2>> :> FALSE), conflicts |-> {}, capacity |-> <<1, 1>>, deadlines |-> <<4, 4, 4>>, dependencies |-> <<{}, {}>>],sampleSchedules |-> <<{1}, {}, {}>>,resourceBookings |-> <<{1}, {1}>>]),
    ([systemMetrics |-> [totalScheduled |-> 2, conflictCount |-> 0, utilizationRate |-> 40, averageLatency |-> -5],workflowTimelines |-> <<{1}, {}>>,lastUpdate |-> 3,activeConstraints |-> {},tensorCalendar |-> [tensor |-> (<<1, 1, 1, 1>> :> TRUE @@ <<1, 1, 1, 2>> :> FALSE @@ <<1, 1, 2, 1>> :> FALSE @@ <<1, 1, 2, 2>> :> FALSE @@ <<1, 1, 3, 1>> :> FALSE @@ <<1, 1, 3, 2>> :> FALSE @@ <<1, 1, 4, 1>> :> FALSE @@ <<1, 1, 4, 2>> :> FALSE @@ <<1, 2, 1, 1>> :> TRUE @@ <<1, 2, 1, 2>> :> FALSE @@ <<1, 2, 2, 1>> :> FALSE @@ <<1, 2, 2, 2>> :> FALSE @@ <<1, 2, 3, 1>> :> FALSE @@ <<1, 2, 3, 2>> :> FALSE @@ <<1, 2, 4, 1>> :> FALSE @@ <<1, 2, 4, 2>> :> FALSE @@ <<2, 1, 1, 1>> :> FALSE @@ <<2, 1, 1, 2>> :> FALSE @@ <<2, 1, 2, 1>> :> FALSE @@ <<2, 1, 2, 2>> :> FALSE @@ <<2, 1, 3, 1>> :> FALSE @@ <<2, 1, 3, 2>> :> FALSE @@ <<2, 1, 4, 1>> :> FALSE @@ <<2, 1, 4, 2>> :> FALSE @@ <<2, 2, 1, 1>> :> FALSE @@ <<2, 2, 1, 2>> :> FALSE @@ <<2, 2, 2, 1>> :> FALSE @@ <<2, 2, 2, 2>> :> FALSE @@ <<2, 2, 3, 1>> :> FALSE @@ <<2, 2, 3, 2>> :> FALSE @@ <<2, 2, 4, 1>> :> FALSE @@ <<2, 2, 4, 2>> :> FALSE @@ <<3, 1, 1, 1>> :> FALSE @@ <<3, 1, 1, 2>> :> FALSE @@ <<3, 1, 2, 1>> :> FALSE @@ <<3, 1, 2, 2>> :> FALSE @@ <<3, 1, 3, 1>> :> FALSE @@ <<3, 1, 3, 2>> :> FALSE @@ <<3, 1, 4, 1>> :> FALSE @@ <<3, 1, 4, 2>> :> FALSE @@ <<3, 2, 1, 1>> :> FALSE @@ <<3, 2, 1, 2>> :> FALSE @@ <<3, 2, 2, 1>> :> FALSE @@ <<3, 2, 2, 2>> :> FALSE @@ <<3, 2, 3, 1>> :> FALSE @@ <<3, 2, 3, 2>> :> FALSE @@ <<3, 2, 4, 1>> :> FALSE @@ <<3, 2, 4, 2>> :> FALSE), conflicts |-> {}, capacity |-> <<1, 1>>, deadlines |-> <<4, 4, 4>>, dependencies |-> <<{}, {}>>],sampleSchedules |-> <<{1}, {}, {}>>,resourceBookings |-> <<{1}, {1}>>])
    >>
----
...
---- CONFIG TensorCalendarSystem_TTrace_1752121745 ----
CONSTANTS
    MaxSamples = 3
    MaxResources = 2
    MaxTimeSlots = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 10 01:29:05 BRT 2025