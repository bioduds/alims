---- MODULE TensorCalendarSystem_TTrace_1752121712 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TensorCalendarSystem_TTrace_1752121712.json", _TETrace)
...
\*
\*trace == IODeserialize("TensorCalendarSystem_TTrace_1752121712.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TensorCalendarSystem_TTrace_1752121712 ----
CONSTANTS
    MaxSamples = 3
    MaxResources = 2
    MaxTimeSlots = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 10 01:28:33 BRT 2025