---- MODULE SimpleSchedulingAgent_TTrace_1752203397 ----
...
_inv ==
    ~(
        ...
        /\
        samplePriorities = ((1 :> "STAT" @@ 3 :> "STAT"))
        /\
        schedulingFailures = ({})
        /\
        sampleTests = ((1 :> {} @@ 3 :> {}))
        ...
        schedulingQueue = (<<1, 3>>)
        /\
        schedulingDecisions = (<<[sampleID |-> 1, success |-> TRUE]>>)
        /\
        scheduledSamples = ({})
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SimpleSchedulingAgent_TTrace_1752203397.json", _TETrace)
...
\*
\*trace == IODeserialize("SimpleSchedulingAgent_TTrace_1752203397.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([samplePriorities |-> <<"STAT">>,schedulingFailures |-> {},sampleTests |-> <<{}>>,resourcesInUse |-> 0,schedulingQueue |-> <<1>>,schedulingDecisions |-> <<>>,scheduledSamples |-> {}]),
    ([samplePriorities |-> (1 :> "STAT" @@ 3 :> "STAT"),schedulingFailures |-> {},sampleTests |-> (1 :> {} @@ 3 :> {}),resourcesInUse |-> 0,schedulingQueue |-> <<1, 3>>,schedulingDecisions |-> <<>>,scheduledSamples |-> {}]),
    ([samplePriorities |-> (1 :> "STAT" @@ 3 :> "STAT"),schedulingFailures |-> {},sampleTests |-> (1 :> {} @@ 3 :> {}),resourcesInUse |-> 0,schedulingQueue |-> <<1, 3>>,schedulingDecisions |-> <<[sampleID |-> 1, success |-> TRUE]>>,scheduledSamples |-> {1}]),
    ([samplePriorities |-> (1 :> "STAT" @@ 3 :> "STAT"),schedulingFailures |-> {},sampleTests |-> (1 :> {} @@ 3 :> {}),resourcesInUse |-> 0,schedulingQueue |-> <<1, 3>>,schedulingDecisions |-> <<[sampleID |-> 1, success |-> TRUE]>>,scheduledSamples |-> {}])
    >>
----
...
---- CONFIG SimpleSchedulingAgent_TTrace_1752203397 ----
CONSTANTS
    MaxSamples = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Jul 11 00:09:58 BRT 2025