---- MODULE TensorCalendarVectorStorageSimple_TTrace_1752131055 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TensorCalendarVectorStorageSimple_TTrace_1752131055.json", _TETrace)
...
\*
\*trace == IODeserialize("TensorCalendarVectorStorageSimple_TTrace_1752131055.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TensorCalendarVectorStorageSimple_TTrace_1752131055 ----
CONSTANTS
    MaxTensors = 2
    MaxVectors = 2
    MaxCollections = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 10 04:04:15 BRT 2025